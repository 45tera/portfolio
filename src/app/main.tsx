      ...
      <div className="grid grid-cols-3 rounded-lg border-1">
        ...
        <div className="col-span-2 ">
          <div className="text-center pt-30">
            <p>/ᐠ - ˕ -マ Ⳋ</p>
            <p className="text-sm text-gray-500 sm:text-center">Year 2 SMU student</p>
            <h4 className="text-2xl">Yee Ming Tan</h4>
            <h3 className="">Certified in Red Hat System Administrator + Cybersecurity</h3>
            <p className="text-sm text-gray-500 sm:text-center">Lillyn Teh Endeavour Scholar</p>

          </div>
          <div className="flex content-center mx-16 mt-16 gap-2">
            <p>♢ skills: </p><Badge variant={"outline"}>Applied Cryptography</Badge><Badge variant={"outline"}>Network and Systems</Badge> <Badge variant={"outline"}>Digital Forensics</Badge> <Badge variant={"outline"}>Communication</Badge>
          </div>
          <div className="flex content-center ml-31 mt-2 gap-2">
            <Badge variant={"outline"}>C#</Badge><Badge variant={"outline"}>C++</Badge>
          </div>
          <div className="flex content-center ml-31 mt-2 gap-2">
            <VscodeIconsFileTypeReactjs />
            <VscodeIconsFileTypePython />
            <DeviconJava />
            <MaterialIconThemeRust />
            <LogosRedhatIcon />
          </div>
